...
# Inria project
def linear_relu_fwd_async_fp32(alpha: float, transA: TransOp, A: Tensor_fp32, transB: TransOp, B: Tensor_fp32, beta: float, C: Tensor_fp32, ndim: int, batch_ndim: int, BH: Tensor_fp32, redux: int, act: int, bias: bool) -> None: ...
