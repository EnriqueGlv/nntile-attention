...
class LinearRelu(BaseLayer):
    ...
    # TODO: implement backward pass for linear relu and not only linear
    ...
    # For now on it only translates to torch as a linear layer
    # in the future, use nn.qat.LinearReLU()
    def to_torch(self):
